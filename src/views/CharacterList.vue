<template>
  ...
  import type { Character } from '../stores/character.ts' // Assuming you have a type for Character
  ...
  // Type annotation for characters
  const charactersTyped: Character[] = characters // Make sure `characters` is properly typed in the store
  </script>
